...
Add the GitHub marketplace and install:

```bash
codex plugin marketplace add https://github.com/jianh-ai/mattpocock-skills-codex.git
codex plugin add mattpocock-skills-codex@mattpocock-skills-codex
```

Update a plugin installed:
```bash
codex plugin marketplace upgrade mattpocock-skills-codex
codex plugin add mattpocock-skills-codex@mattpocock-skills-codex
```

### Codex Desktop

In the Plugins or Marketplace settings, add a Git marketplace with these values:
